...
//         // Build Frappe-compatible payload with exact field names
//         const payload = {
//             date: body.date || null,
...
//         return NextResponse.json({ error: 'Failed to create application form' }, { status: 500 });
//     }
// }

// // PUT: Update existing Application Form
...
//         return NextResponse.json({ error: 'Failed to update application form' }, { status: 500 });
//     }
// }
