...
//                 setJobOpenings(prev => prev.map(j => j.name === updated.name ? updated : j))
//                 setFilteredJobs(prev => prev.map(j => j.name === updated.name ? updated : j))
...
//                                             {/* ── EDITABLE: Salary Range (read-only) ── */}
//                                             <div className="jol-detail-field">
...
//                                                     <div className="jol-edit-row">
//                                                         <input type="date" className="jol-edit-date" value={editPostedOn} onChange={e => setEditPostedOn(e.target.value)} />
...
//                                                     <div className="jol-edit-row">
//                                                         <input type="date" className="jol-edit-date" value={editClosesOn} onChange={e => setEditClosesOn(e.target.value)} />
